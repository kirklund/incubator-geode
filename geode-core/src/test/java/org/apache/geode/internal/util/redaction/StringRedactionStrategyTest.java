...
@Ignore("Delete StringRedactionStrategyTest and related code before merging")
public class StringRedactionStrategyTest {

  private static final String REDACTED = "redacted";

  private StringRedactionStrategy stringRedactionStrategy;
  ...
  public void setUp() {
    ...
    stringRedactionStrategy =
        new StringRedactionStrategy(sensitiveDataDictionary::isSensitive, REDACTED);
  }
  ...
  public void redact_endsWithPassword_afterHyphenD_isRedacted() {
    ...
    String output = stringRedactionStrategy.redact(input);
