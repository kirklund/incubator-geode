...
@Ignore("Delete PicocliRedactionStrategyTest and related code before merging")
public class PicocliRedactionStrategyTest {

  private static final String REDACTED = "redacted";

  private PicocliRedactionStrategy picocliRedactionStrategy;
  ...
  public void setUp() {
    ...
    picocliRedactionStrategy =
        new PicocliRedactionStrategy(sensitiveDataDictionary::isSensitive, REDACTED);
  }
  ...
  public void redact_endsWithPassword_afterHyphenD_isRedacted() {
    ...
    String output = picocliRedactionStrategy.redact(input);
  ...
  public void redact_endsWithPassword_afterHyphensJD_isRedacted2() {
    String string = "--J=-Dsome.highly.qualified.password=";
    String sensitive = "secret";
    String input = String.format(string, sensitive);
    String expected = String.format(string, REDACTED);
  ...
  public void redact_gemfireSslKeystorePassword_isRedacted() {
    String string = "-Dgemfire.ssl-keystore-password=";
    String sensitive = "gibberish";
    String input = String.format(string, sensitive);
    String expected = String.format(string, REDACTED);
  ...
  @Test
  public void redact_sensitiveBeginsWithHyphen_isNotRedacted() {
    String string = "-Dgemfire.ssl-keystore-password=%s";
    String sensitive = "-supersecret";
    String input = String.format(string, sensitive);
