...
import org.apache.geode.internal.serialization.filter.ImplObjectInputFilterFactory;
...
public abstract class InternalDataSerializer extends DataSerializer {
  ...
  public static void initializeSerializationFilter(SerializableObjectConfig config,
    ...
    ObjectInputFilterFactory objectInputFilterFactory = new ImplObjectInputFilterFactory(() -> {
