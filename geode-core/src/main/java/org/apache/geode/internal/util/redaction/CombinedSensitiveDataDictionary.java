...
/**
 * Combines two SensitiveDataDictionaries by delegating to both for isSensitive results.
 */
class CombinedSensitiveDataDictionary implements SensitiveDataDictionary {

  private final Iterable<SensitiveDataDictionary> dictionaries;

  CombinedSensitiveDataDictionary(SensitiveDataDictionary... dictionaries) {
