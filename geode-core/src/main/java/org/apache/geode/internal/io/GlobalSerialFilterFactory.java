...
public class GlobalSerialFilterFactory {
  ...
  public GlobalSerialFilter create(String pattern, Iterable<DistributedSystemService> services,
      SanctionedSerializables sanctionedSerializables) {
    return create(pattern, sanctionedSerializables.loadSanctionedClassNames(services));
  }
