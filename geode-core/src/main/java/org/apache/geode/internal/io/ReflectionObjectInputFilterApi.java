...
class ReflectionObjectInputFilterApi implements ObjectInputFilterApi {
   ...
   */
  ReflectionObjectInputFilterApi(String apiPackage)
      throws ClassNotFoundException, NoSuchMethodException {
    this.apiPackage = apiPackage;

    ClassPathLoader classPathLoader = ClassPathLoader.getLatest();

    ObjectInputFilter = ObjectInputFilter(classPathLoader);
    ObjectInputFilter_Config = ObjectInputFilter_Config(classPathLoader);
    ObjectInputFilter_FilterInfo = ObjectInputFilter_FilterInfo(classPathLoader);
    Class<?> ObjectInputFilter_Status = ObjectInputFilter_Status(classPathLoader);
  ...
  private Class<?> ObjectInputFilter(ClassPathLoader classPathLoader)
      throws ClassNotFoundException {
    return classPathLoader.forName(apiPackage + "ObjectInputFilter");
  }
  ...
  private Class<?> ObjectInputFilter_Status(ClassPathLoader classPathLoader)
      throws ClassNotFoundException {
    return classPathLoader.forName(apiPackage + "ObjectInputFilter$Status");
  }

  /** {@code public final class Config} */
  private Class<?> ObjectInputFilter_Config(ClassPathLoader classPathLoader)
      throws ClassNotFoundException {
    return classPathLoader.forName(apiPackage + "ObjectInputFilter$Config");
  }
  ...
  private Class<?> ObjectInputFilter_FilterInfo(ClassPathLoader classPathLoader)
      throws ClassNotFoundException {
    return classPathLoader.forName(apiPackage + "ObjectInputFilter$FilterInfo");
  }
