...
/**
 * Java 9 has java.io.ObjectInputFilter and uses ObjectInputStream.setObjectInputFilter()
 */
public class Java9InputStreamFilter implements InputStreamFilter {
  ...
  public Java9InputStreamFilter(String serializationFilterSpec,
  ...
  private void createJava9Filter(String serializationFilterSpec,
      Collection<String> sanctionedClasses) {
    try {
      filterInfoClass = Class.forName("java.io.ObjectInputFilter$FilterInfo");
      serialClassMethod = filterInfoClass.getDeclaredMethod("serialClass");


      filterClass = Class.forName("java.io.ObjectInputFilter");
      ...
      configClass = Class.forName("java.io.ObjectInputFilter$Config");
