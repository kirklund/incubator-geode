...
public class ConditionalGlobalSerialFilterConfiguration implements GlobalSerialFilterConfiguration {
  ...
  public boolean configure() {
    ...
    return new Java8GlobalSerialFilterConfigurationFactory()
