...
public class ConditionalJmxSerialFilterConfigurationFactory
  ...
  public ConditionalJmxSerialFilterConfigurationFactory() {
    this(() -> isJavaVersionAtLeast(JAVA_9) &&
        isBlank(System.getProperty("jmx.remote.rmi.server.serial.filter.pattern")));
  }
  ...
  @Override
  public JmxSerialFilterConfiguration create() {
    if (enableFiltering.isEnabled()) {
      return new ConditionalJmxSerialFilterConfiguration();
    }
    return () -> false;
  }
}
