...
public class DelegatingGlobalSerialFilterFactory implements GlobalSerialFilterFactory {

  private final ObjectInputFilterApiFactory apiFactory;

  public DelegatingGlobalSerialFilterFactory() {
    this(new ReflectionObjectInputFilterApiFactory());
  }

  @VisibleForTesting
  DelegatingGlobalSerialFilterFactory(ObjectInputFilterApiFactory apiFactory) {
