...
public class SystemPropertySerialFilterTest {
  ...
  @Test
  public void setsPropertyValue_ifSupported() {
    FilterConfiguration filterConfiguration = new SystemPropertySerialFilter()
        .propertyName(SYSTEM_PROPERTY)
  ...
  @Test
  public void doesNotSetPropertyValue_ifUnsupported() {
    FilterConfiguration filterConfiguration = new SystemPropertySerialFilter()
        .propertyName(SYSTEM_PROPERTY)
        .filterPattern(filterPattern)
        .condition(() -> false)
